    ...
    return (
        <MegaMenu>
          <NavbarBrand href="/">
            ...
            <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white"> Bienvenido {user.rol === 'enfermero' ? 'Enfermero' : user.rol === 'medico' ? 'Medico' : ''} {user.name} </span>
          </NavbarBrand>
          <div className="order-2 hidden items-center md:flex">
          {user?<Button color='red' onClick={handleLogout}>Cerrar Sesion</Button>:null}
