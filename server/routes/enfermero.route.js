...
EnfermeroRouter.get(
  ...
  authenticate,
  EnfermeroController.obtenerIndicadoresGlobales
);

EnfermeroRouter.get(
  "/usuario/:id",
  authenticate,
  EnfermeroController.getEnfermeroByUsuarioId
);
...
EnfermeroRouter.put(
  "/:id",
  authenticate,
  EnfermeroController.updateOneEnfermeroById
);

EnfermeroRouter.delete(
  "/:id",
  authenticate,
  EnfermeroController.deleteOneEnfermeroById
);
